...
CREATE TABLE SpotifyClone.sign_plan (
    plan_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    plan_name VARCHAR(99) NOT NULL,
    plan_price DECIMAL(10,2) NOT NULL
) engine = InnoDB;

INSERT INTO SpotifyClone.sign_plan (plan_id, plan_name, plan_price)
VALUES
    (1, 'gratuito', 0),
...
CREATE TABLE SpotifyClone.users (
    ...
    foreign key (plan_id) references sign_plan(plan_id)
) engine = InnoDB;

INSERT INTO SpotifyClone.users (user_id, user_name, user_age, plan_id, sign_date)
VALUES
...
INSERT INTO SpotifyClone.albuns (album_Id, album_name, artist_id, launch_year)
VALUES
    (1, 'Envious', 1, 1990),
    (2, 'Exuberant', 1, 1993),
...
CREATE TABLE SpotifyClone.historic (
    ...
    reproduction_historic DATETIME NOT NULL,
    CONSTRAINT PRIMARY KEY (user_id, song_id),
    foreign key (user_id) references users(user_id),
    foreign key (song_id) references songs(song_id)
) engine = InnoDB;

INSERT INTO SpotifyClone.historic (user_id, song_id, reproduction_historic)
