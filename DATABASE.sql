...
--
-- Host: localhost    Database: TaskData
-- ------------------------------------------------------
...
CREATE TABLE `Tasks` (
  ...
  CONSTRAINT `Tasks_ibfk_1` FOREIGN KEY (`task_status_id`) REFERENCES `Task_Status` (`status_id`)
...
-- Dump completed on 2022-06-29 17:11:38
